...
export default function GroupClassesLandingPage() {
  return (
    <main className="w-full overflow-x-hidden">
      ...
      {/* Programs Section */}
      <section className="bg-[#f3f3f4] pt-8 pb-12 md:pt-12 md:pb-20 px-4 md:px-8">
      ...
      {/* Social Proof */}
      <section className="bg-[#f3f3f4] py-12 md:py-20 px-4 md:px-8">
      ...
      {/* Bottom Form */}
      <section id="form" className="py-12 md:py-20 px-4 md:px-8 scroll-mt-16 bg-white">
        <div className="max-w-xl mx-auto">
          <h2 className="font-bebas text-4xl md:text-5xl uppercase mb-8 text-center text-[#1a1c1c]">
