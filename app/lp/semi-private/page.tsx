    ...
    <main className="w-full overflow-x-hidden">
      ...
      <section className="bg-[#f3f3f4] py-20 md:py-32 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-bebas text-4xl md:text-5xl uppercase mb-12 text-[#1a1c1c]">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-[#5f5e5e] uppercase">
              <li><a className="hover:text-[#bb0012]" href="#">Semi-Private</a></li>
              <li><a className="hover:text-[#bb0012]" href="#">HIIT Class</a></li>
            </ul>
          </div>
        </div>
